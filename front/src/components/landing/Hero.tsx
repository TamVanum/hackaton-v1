...
export default function Hero() {
  ...
  const fallBackData = [
    { "msg": "Bienvenido hijo de tu pta verga, a la vrga prro (╯°□°)╯︵ ┻━┻" }, 
    { "msg": "Me relajo prro, me vine muy arriba, es que esto esta muy brigido ┬─┻ノ( º _ ºノ)" }, 
    { "msg": "Ya con esto me retiro, como un campeon, valio todo la pena 😎" }, 
    { "msg": "Se cierra el estadio señores 🏟️" }, 
    { "msg": "A mimir 😴" }
  ]
